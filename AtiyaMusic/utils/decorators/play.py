...
from AtiyaMusic.utils.database import (get_cmode, get_lang,
                                       get_playmode, get_playtype,
                                       is_active_chat,
                                       is_commanddelete_on,
                                       is_served_private_chat)
from AtiyaMusic.utils.database.memorydatabase import is_maintenance
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            callback_data="AtiyaMusicymousAdmin",
                        ),
                    ]
                ]
            )
