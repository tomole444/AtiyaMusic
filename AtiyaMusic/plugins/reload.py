...
from AtiyaMusic.utils.database import get_authuser_names, get_cmode
from AtiyaMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from AtiyaMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await AtiyaMusic.stop_stream(message.chat.id)
    except:
        pass
