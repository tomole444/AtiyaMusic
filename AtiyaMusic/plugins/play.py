...
from AtiyaMusic import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from AtiyaMusic.core.call import AtiyaMusic
from AtiyaMusic.utils import seconds_to_min, time_to_seconds
from AtiyaMusic.utils.channelplay import get_channeplayCB
from AtiyaMusic.utils.database import is_video_allowed
from AtiyaMusic.utils.decorators.language import languageCB
from AtiyaMusic.utils.decorators.play import PlayWrapper
from AtiyaMusic.utils.formatters import formats
from AtiyaMusic.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AtiyaMusic.utils.database import is_served_user
from AtiyaMusic.utils.inline.playlist import botplaylist_markup
from AtiyaMusic.utils.logger import play_logs
from AtiyaMusic.utils.stream.stream import stream
...
async def play_commnd(
    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            try:
                await AtiyaMusic.stream_call(url)
...
@app.on_callback_query(
    filters.regex("AtiyaMusicymousAdmin") & ~BANNED_USERS
)
async def AtiyaMusicymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("AtiyaMusicPlaylists") & ~BANNED_USERS
)
@languageCB
